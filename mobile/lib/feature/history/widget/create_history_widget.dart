...
class CreateHistoryWidget extends ConsumerWidget {
  CreateHistoryWidget(this.orderId, {Key? key}) : super(key: key);
  final String orderId;
  final _amountController = TextEditingController();
  final _moneyKeeperController = TextEditingController();
  final _noteController = TextEditingController();
  final _paymentReasonController = TextEditingController();
  final _typeController =
      TextEditingController(text: PaymentTypeEnum.CASH.name);
  String _moneyKeeper= '';
