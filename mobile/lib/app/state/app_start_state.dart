...
class AppStartState with _$AppStartState {
  ...
  const factory AppStartState.floristAuthenticated() = FloritsAppAuthenticated;

  const factory AppStartState.shipperAuthenticated() = ShipperAppAuthenticated;

  const factory AppStartState.adminAuthenticated() = AdminAppAuthenticated;
